...
type EncryptedParquetWriter struct {
	SchemaHandler *schema.SchemaHandler
	NP            int64 //parallel number
	Footer        *parquet.FileCryptoMetaData
...
func NewEncryptedParquetWriterFromWriter(w io.Writer, obj interface{}, np int64) (*EncryptedParquetWriter, error) {
	wf := writerfile.NewWriterFile(w)
	return NewEncryptedParquetWriter(wf, obj, np)
}

//Create a parquet handler. Obj is a object with tags or JSON schema string.
func NewEncryptedParquetWriter(pFile source.ParquetFile, obj interface{}, np int64) (*EncryptedParquetWriter, error) {
	var err error
...
func (pw *EncryptedParquetWriter) SetSchemaHandlerFromJSON(jsonSchema string) error {
	var err error
...
func (pw *EncryptedParquetWriter) RenameSchema() {
...
func (pw *EncryptedParquetWriter) WriteStop() error {
	var err error
...
func (pw *EncryptedParquetWriter) Write(src interface{}) error {
	var err error
...
func (pw *EncryptedParquetWriter) flushObjs() error {
	var err error
	l := int64(len(pw.Objs))
	if l <= 0 {
		return nil
...
func (pw *EncryptedParquetWriter) Flush(flag bool) error {
	var err error
